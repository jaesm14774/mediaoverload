...
支援從資料庫批量取 news 或使用自定義 prompts 進行批量生成：
...
詳細範例請參考 `examples/all_strategies_examples.ipynb`
...
#### 配置參數
- `longvideo_config.skip_candidate_stage`: 是否跳過候選圖片階段（預設 False）
