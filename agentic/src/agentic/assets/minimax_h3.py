...
PROFILES: dict[str, MiniMaxH3Profile] = {
    ...
    "ultra-lowvram": MiniMaxH3Profile(
        name="ultra-lowvram",
        workflow_name="minimax_h3_ultra_lowvram_i2v",
        summary=(
...
def inspect_asset(asset: MiniMaxH3Asset, comfy_root: Path) -> dict[str, Any]:
    ...
    if not path.exists():
        return {
            ...
            "expected_size_human": _format_bytes(asset.expected_size),
            "source": asset.source,
            "trust": asset.trust,
        }
...
def inspect_profile(profile: MiniMaxH3Profile | str, comfy_root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "total_size_human": _format_bytes(resolved.total_bytes),
...
def profile_manifest(profile: MiniMaxH3Profile | str) -> dict[str, Any]:
    ...
    return {
        ...
        "profile": resolved.name,
        "summary": resolved.summary,
        "media_types": ["image_to_video", "image_to_video_audio", "text2video", "long_video"],
